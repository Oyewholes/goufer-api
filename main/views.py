...
from main.serializers import CategorySerializer, ErrandBoyDocumentSerializer, GoferDocumentSerializer, LocationSerializer, SubCategorySerializer, ReviewsSerializer, VendorDocumentSerializer, ErrandSerializer
from user.models import ErrandBoy, Gofer, Vendor, Errand
...
class ErrandViewSet(ModelViewSet):
    ...
    def get_queryset(self):
        user = self.request.user
        return Errand.objects.filter(costumuser=self.request.user)
